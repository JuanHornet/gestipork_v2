    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        dialog.setOnShowListener(d -> {
            dialog.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener(v -> {
                ...
                if (getActivity() instanceof com.example.gestipork_v2.modelo.DetalleLoteActivity) {
                    ((com.example.gestipork_v2.modelo.DetalleLoteActivity) getActivity()).refrescarResumenLote();
                }
